-- fixes function added in 20240720124825_handle_user_nullable_fields.sql
-- previous function was not handling the case where the user has accepted an invitation before signing up
