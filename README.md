...
| `SUPABASE_STORAGE_BUCKET`                | [Supabase Storage](https://supabase.com/storage) is used for storing files. How to create a bucket? `Supabase > Your instance > Storage > New bucket`.                                                                                                                                                                                                                                                           |         |
