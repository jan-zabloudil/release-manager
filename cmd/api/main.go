...
func main() {
	...
	svc := service.NewService(repo.Auth, repo.User, repo.Project, repo.Environment, repo.Settings)
	h := transport.NewHandler(svc.Auth, svc.User, svc.Project, svc.Settings)
