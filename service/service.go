...
type releaseRepository interface {
	...
	ReadReleaseAttachment(ctx context.Context, projectID, releaseID, attachmentID uuid.UUID) (model.ReleaseAttachment, error)
	DeleteReleaseAttachment(ctx context.Context, projectID, releaseID, attachmentID uuid.UUID) error
}
...
type fileManager interface {
	DeleteFileAsync(ctx context.Context, filePath string)
}
